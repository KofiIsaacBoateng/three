...
const Showcase = () => {
  ...
  useGSAP(() => {
    if (!isTablet) {
      ...
      tl.to(".mask img", { transform: "scale(1.1)" }).to(".content", {
        opacity: 1,
        y: 0,
        ease: "power1.in",
      });
        ...
        <div className="wrapper">
          <div className="lg:max-w-md">
            ...
            <div className="space-y-5 mt-7 pe-10">
              <p>
                Introducing{" "}
                <span>M4, the next generation of Apple Silicon</span> . M4
                powers
              </p>
              <p>
                It drives Apple Intelligence on iPad Pro, so you can write,
                create, and accomplish more with ease. All in a design that is
